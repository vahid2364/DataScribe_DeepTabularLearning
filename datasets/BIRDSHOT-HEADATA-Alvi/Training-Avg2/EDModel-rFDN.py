...
# %%
    ...
    study_infos = [
        {"name": 'distributed-FDN-Optuna', "url": "sqlite:///../Hyperparameter-optimization/Encoder-Decoder-FDN-Optuna-overcomplete-Avg HDYNHQSRatio-SMAPE/distributed-FDN-Optuna.db"}
    ]
