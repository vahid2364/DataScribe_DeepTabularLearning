...
# %%
    ...
    study_infos = [
        {"name": 'distributed-FDN-Optuna', "url": "sqlite:///../Hyperparameter-optimization/Encoder-Decoder-FDN-Optuna-overcomplete-Depth of Penetration (mm) FE_Sim-SMAPE/distributed-FDN-Optuna.db"}
    ]
