...
if __name__ == "__main__":
    ...
    plt.text(0.05, 0.95, f'MSE-Test: {mse_test:.3f}', transform=plt.gca().transAxes, fontsize=15, verticalalignment='top')
    plt.text(0.05, 0.92, f'r$^2$-Test : {r2_test :.3f}', transform=plt.gca().transAxes, fontsize=15, verticalalignment='top')
    plt.text(0.05, 0.88, f'SMAPE-Test: {smape_test:.2f}%', transform=plt.gca().transAxes, fontsize=15, verticalalignment='top')
    #
    plt.text(0.05, 0.80, f'MSE-Train: {mse:.3f}', transform=plt.gca().transAxes, fontsize=15, verticalalignment='top')
    plt.text(0.05, 0.77, f'r$^2$-Train : {r2 :.3f}', transform=plt.gca().transAxes, fontsize=15, verticalalignment='top')
    plt.text(0.05, 0.73, f'SMAPE-Train: {smape:.2f}%', transform=plt.gca().transAxes, fontsize=15, verticalalignment='top')
