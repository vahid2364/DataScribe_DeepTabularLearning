...
file_path = '../Encoder-Decoder-FDN-Optuna-overcomplete-UTSandYS/optuna_trials.csv'  # Update with the correct path if needed
optunaTrials = pd.read_csv(file_path)

# Display the first few rows of the DataFrame
print(optunaTrials.head())

params = optunaTrials.iloc[245,:]
...
decoder_neurons    = json.loads(params.user_attrs_neurons_per_layer_encoder)
