...
optuna_file_path = '../../Hyperparameter-optimization/Encoder-Decoder-FDN-Optuna-overcomplete-YS/optuna_trials.csv'

# Extract parameters
params = read_optuna_parameters(optuna_file_path, trial_index=188)
