...
#        \textbf{Model Name} & YS 1000C PRIOR & 1273K Density (g/cc) & 1273K THCD (W/mK) & Kou Criteria & 1300C Creep CB [1/s] \\ 


#output_column_names = ['Yield Strength, 1000$^\circ$C', 'Pugh Ratio', 'Creep (CB), 1000$^\circ$C [1/s]', 'Kou Criteria', 'Creep Merit']
output_column_names = ['Yield Strength, 1000$^\circ$C', 'EQ 1273K Density (g/cc)', 'EQ 1273K THCD (W/mK)', 'Kou Criteria', '1300 Min Creep CB [1/s]']
...
#threshold_series = df['Creep Merit']
