...
output_column_names = ['Yield Strength, 1000$^\circ$C','Yield Strength, 1000$^\circ$C','Pugh Ratio', 'Creep (CB), 1000$^\circ$C [1/s]', 'Creep (CB), 1500$^\circ$C [1/s]']
...
print('Inspect original data - log scale and normal scale')
