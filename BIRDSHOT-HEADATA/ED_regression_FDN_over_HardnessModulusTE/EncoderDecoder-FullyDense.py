...
file_path = '../Encoder-Decoder-FDN-Optuna-overcomplete-HardnessModulus/optuna_trials.csv'  # Update with the correct path if needed
optunaTrials = pd.read_csv(file_path)

# Display the first few rows of the DataFrame
print(optunaTrials.head())

params = optunaTrials.iloc[452,:]
