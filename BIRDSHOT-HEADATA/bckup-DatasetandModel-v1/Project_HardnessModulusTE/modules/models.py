...
def read_optuna_parameters(file_path, trial_index=245):
    """
    ...
    # Sort the DataFrame by the column 'value_2' in descending order
    optuna_trials_sorted = optuna_trials.sort_values(by='values_2', ascending=False)
    ...
    # Optionally, reset the display options afterward
