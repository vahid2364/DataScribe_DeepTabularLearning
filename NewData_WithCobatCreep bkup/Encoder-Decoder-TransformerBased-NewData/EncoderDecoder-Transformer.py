...
from Transformer_Model import transformer_encoder,transformer_decoder
...
encoder = transformer_encoder(input_dim=input_dim, 
                              d_model=d_model, 
                              num_heads=num_heads, 
                              ff_dim=ff_dim, 
...
decoder = transformer_decoder(output_dim=output_dim, 
                              d_model=d_model, 
                              num_heads=num_heads, 
                              ff_dim=ff_dim, 
                              num_layers=num_layers, 
